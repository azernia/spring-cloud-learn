...
public class RedisUtils {
     ...
     * @return 对应的多个键值
     */
    public Map<Object, Object> hashGetByKeys(String key) {
     ...
     */
    public boolean hashSetByKeys(String key, Map<String, Object> map) {
        try {
     ...
     * @return true成功 false失败
     */
    public boolean hashSetByKeys(String key, Map<String, Object> map, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            if (time > 0) {
                expire(key, time);
